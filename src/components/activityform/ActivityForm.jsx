...
import { SEASONS, RESET_ACTIVITY_STATE } from '../../lib/constants'
...
const ActivityForm = () => {
  ...
  const isShowSearchResults = inputFormFilter.length < allCountries.length
...
{ 
      modal.show && <ModalMessage message={modal.message}/>}
